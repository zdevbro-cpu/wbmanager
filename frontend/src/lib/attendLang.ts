...
const KO: Dict = {
  ...
  scanHint: 'QR 인식이 안 되면 사번을 적고 Enter',
  inAt: '출근',
  outAt: '퇴근',
...
const EN: Dict = {
  ...
  scanHint: 'If the QR will not read, type your ID and press Enter',
  inAt: 'In',
  outAt: 'Out',
...
const RU: Dict = {
  ...
  scanHint: 'Если QR не считывается, введите табельный номер и нажмите Enter',
  inAt: 'Приход',
  outAt: 'Уход',

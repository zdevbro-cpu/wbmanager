...
export const primaryBtnCls =
  'inline-flex h-10 items-center gap-1.5 rounded-[10px] bg-primary px-4 text-sm font-bold text-white hover:brightness-110 disabled:opacity-50 disabled:pointer-events-none';

export const outlineBtnCls =
  'inline-flex h-10 items-center gap-1.5 rounded-[10px] border border-border px-4 text-sm font-bold text-text-mid hover:bg-hover';
